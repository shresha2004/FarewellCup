...
export default function Navbar({ scrollToSection, isAdmin, setIsadmin }) {
  ...
  return (
    <Disclosure
      as="nav"
      className={`fixed top-0 w-full z-50 transition-all duration-300 shadow-lg ${scrolling ? "bg-[#802BB1] shadow-lg" : "bg-[#2D283E]"
        }`}
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-white hover:bg-[#802BB1] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
